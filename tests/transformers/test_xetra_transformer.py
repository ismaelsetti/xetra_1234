...
class TestXetraETLMethods(unittest.TestCase):
    ...
    def setUp(self):
        ...
        # Creating S3BucketConnector testing instance
        ...
        conf_dict_src = {
            ...
            'src_columns': ['ISIN', 'Mnemonic', 'Date', 'Time', 'StartPrice',
        ...
        data_report = [['AT0000A0E9W5', '2021-04-17', 20.21, 21.19, 18.21, 21.34, 1088, 0.00],
                       ['AT0000A0E9W5', '2021-04-18', 20.58, 21.14, 18.89, 21.14, 10286, -0.24],
                       ['AT0000A0E9W5', '2021-04-19', 23.58, 22.21, 22.21, 25.01, 3586, 5.06]]
