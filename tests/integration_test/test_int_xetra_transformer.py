...
class IntTestXetraETLMethods(unittest.TestCase):
    ...
    def setUp(self):
        ...
        self.s3_bucket_name_src = 'xetra-int-test-src-ismael'
        self.s3_bucket_name_trg = 'xetra-int-test-trg-ismael'
        ...
        data_report = [['AT0000A0E9W5', self.dates[3], 20.21, 21.19, 18.21, 21.34, 1088, 0.00],
