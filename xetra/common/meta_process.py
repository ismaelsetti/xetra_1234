...
class MetaProcess():
    ...
    def update_meta_file(s3_bucket_meta: S3BucketConnector, meta_key: str, extract_date_list: list):
        """
        Updating the meta file with the processed Xetra dates and todays dates as processed date
    ...
    @staticmethod
    def return_date_list(s3_bucket_meta: S3BucketConnector, first_date: str, meta_key: str):
        """
        ...
        returns:
          ...
          return_date_list: list of all date from min_date till today
        """
